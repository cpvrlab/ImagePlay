...
{
    // init
    IPLImage* image = new IPLImage(IPLData::IMAGE_GRAYSCALE, 1024, 512);
    QCOMPARE(image->width(), 1024);
    QCOMPARE(image->height(), 512);
    QCOMPARE(image->type(), IPLData::IMAGE_GRAYSCALE);
...
{
    // init
    IPLImage* image = new IPLImage(IPLData::IMAGE_COLOR, 1024, 512);
    QCOMPARE(image->width(), 1024);
    QCOMPARE(image->height(), 512);
    QCOMPARE(image->type(), IPLData::IMAGE_COLOR);
