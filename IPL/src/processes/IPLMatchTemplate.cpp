...
/*!
 * \brief IPLMatchTemplate::getResultData
 ...
 * \return
 */
IPLData* IPLMatchTemplate::getResultData(int index)
{
    if(index == 0)
        return _result;
    else if(index == 1)
